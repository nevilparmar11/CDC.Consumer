...
namespace CDC.Employee.Infrastructure.Extension
{
    public class SqlExtension : ISqlExtension
    {
        ...
        public async Task<T> Get<T>(string query, object parameters = null, string mirrorConnectionString = "ConnectionStrings:CloudDBMirror", string connectionString = "ConnectionStrings:CloudDBMain")
        {
            T result;
        ...
        public async Task<IEnumerable<T>> GetList<T>(string sqlQuery, object parameters = null, string mirrorConnectionString = "ConnectionStrings:CloudDBMirror", string connectionString = "ConnectionStrings:CloudDBMain")
        {
